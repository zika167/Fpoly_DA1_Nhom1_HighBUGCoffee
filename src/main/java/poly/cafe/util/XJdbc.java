...
public class XJdbc {
    ...
    public static int executeUpdate(String sql, Object... values) {
        try (
                Connection conn = openConnection(); PreparedStatement stmt = prepareStatement(conn, sql, values)) {
    ...
    public static <T> T getValue(String sql, Object... values) {
        try (
                Connection conn = openConnection(); PreparedStatement stmt = prepareStatement(conn, sql, values); ResultSet rs = stmt.executeQuery()) {
            if (rs.next()) {
    ...
    public static void main(String[] args) {
        ...
        try (
                Connection conn = openConnection(); PreparedStatement stmt = prepareStatement(conn, "SELECT * FROM Categories"); ResultSet rs = stmt.executeQuery()) {
            while (rs.next()) {
