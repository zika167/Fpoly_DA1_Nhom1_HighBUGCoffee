...
public class CategoryManagerJDialog extends javax.swing.JDialog implements CategoryController {
    ...
    public void delete() {
        if (XDialog.confirm("Bạn thực sự muốn xóa?")) {
            ...
            if (!id.trim().isEmpty()) {
                ...
                XDialog.alert("Mã loại không được để trống khi xóa!");
            }
        }
    }
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addComponent(btnUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 105,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(btnDelete, javax.swing.GroupLayout.PREFERRED_SIZE, 105,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout
                                                        ...
                                                        .addComponent(txtId, javax.swing.GroupLayout.DEFAULT_SIZE, 336,
                                                                Short.MAX_VALUE))
                                                .addGap(12, 12, 12)
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoryManagerJDialog.class.getName())
