...
public class RevenueManagerJDialog extends javax.swing.JDialog implements RevenueController {
    ...
    private void fillRevenueByCategory(Date begin, Date end) {
        String shopId = poly.cafe.util.XAuth.user != null ? poly.cafe.util.XAuth.user.getShopId() : null;
        List<Revenue.ByCategory> items = dao.getByCategory(begin, end, shopId);
        ...
        items.forEach(item -> {
            Object[] row = {
                    ...
                    item.getDrinkName(),
                    item.getQuantity(),
                    String.format("%,.0f VNĐ", item.getRevenue()).replace(',', '.')
            };
            model.addRow(row);
        });
    }
    ...
    private void fillRevenueByUser(Date begin, Date end) {
        String shopId = poly.cafe.util.XAuth.user != null ? poly.cafe.util.XAuth.user.getShopId() : null;
        List<Revenue.ByUser> items = dao.getByUser(begin, end, shopId);
    ...
    private void initComponents() {
        ...
        tblByCategory.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Loại đồ uống", "Tên đồ uống", "SL bán", "Doanh thu"
                }));
        ...
        tblByUser.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Mã nhân viên", "Tên nhân viên", "Số bill bán", "Doanh thu"
                }));
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(cboTimeRanges, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                ...
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(15, 15, 15)
                                .addComponent(tabs, javax.swing.GroupLayout.PREFERRED_SIZE, 252,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RevenueManagerJDialog.class.getName())
